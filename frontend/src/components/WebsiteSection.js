...
export default function WebsiteSection({ queries }) {
    ...
    const websites = [
      {
        ...
        text: "<h1> Wikipedia - Quing dynasty </h1>",
      },
  ...
  return (
    <div className="section">
      <h2 className="title">Step 2: Browse the web for relevant webistes</h2>
      <p className="subtitle">
        Delete queries you don't like or add new if needed. Then, click
        "search".
      </p>
        ...
        >
          {({ TransitionProps }) => (
            <Fade {...TransitionProps} timeout={350}>
              <Paper
                className="p-4 shadow-xl rounded-lg max-w-sm bg-white border border-gray-300"
